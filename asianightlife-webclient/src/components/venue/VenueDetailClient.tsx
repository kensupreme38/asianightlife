...
const VenueReviews = dynamic(
  () => import("@/components/venue/VenueReviews").then((mod) => ({ default: mod.VenueReviews })),
    ...
    <div className="min-h-screen bg-background">
      ...
      <main id="main-content" className="container py-8 px-4 sm:px-8">
        ...
        <article id="venue-content" itemScope itemType="https://schema.org/LocalBusiness">
          ...
          {/* Reviews Section */}
          <section className="mb-12" aria-label="Reviews">
            <VenueReviews venueName={venue.name} venueSlug={venue.slug} />
          </section>
